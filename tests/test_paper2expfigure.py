"""
测试 paper2expfigure workflow
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
生成时间: 2025-12-07 23:27:33

运行方式:
  pytest tests/test_paper2expfigure.py -v -s
  或直接: python tests/test_paper2expfigure.py
"""
...
# ============ 核心异步流程 ============
async def run_paper2expfigure_pipeline() -> xxState:
    """
    执行 paper2expfigure 工作流的测试流程
    """
    # TODO: 根据实际需求构造初始状态
    # 1) 如果使用自定义请求对象，在这里构造
    # req = YourRequest(
    ...
    # 3) 通过注册中心执行工作流
    final_state: xxState = await run_workflow("paper2expfigure", state)
    return final_state


# ============ pytest 入口 ============
@pytest.mark.asyncio
async def test_paper2expfigure_pipeline():
    """
    测试 paper2expfigure 工作流的完整流程
    """
    final_state = await run_paper2expfigure_pipeline()
...
if __name__ == "__main__":
    ...
    允许直接运行此文件进行快速测试
    """
    asyncio.run(run_paper2expfigure_pipeline())