...
async def run_paper2page_content_pipeline_pdf() -> Paper2FigureState:
    ...
    req.input_type = "TOPIC"
    req.model = "gpt-5.1"
    req.page_count = 2
    req.chat_api_url = "http://123.129.219.111:3000/v1"
    req.style = "北京大学风格；英文；"
...
# ![](images/7e5aaba3a3a7f79a5f67b50a91ba1b63821471b1fe77016509207ade82714e2e.jpg)  
...
#     """
    ...
    print(f"final_state: {final_state['pagecontent']}")
