...
def create_operator_prompt_writing_graph() -> GenericGraphBuilder:
    ...
    def pre_get_recommendation(state: DFState):
        op_name = state.prompt_op_name
    ...
    # ---------------- 节点实现 ----------------
    async def prompt_writing_node(s: DFState) -> DFState:
