...
def create_websearch_knowledge_store_graph() -> GenericGraphBuilder:  # noqa: N802
    ...
    async def planner_node(state: WebsearchKnowledgeState) -> WebsearchKnowledgeState:
        ...
        """
        from dataflow_agent.agentroles.data_agents.websearch_planner import create_websearch_planner_agent
    ...
    async def initial_analyzer_node(state: WebsearchKnowledgeState) -> WebsearchKnowledgeState:
        ...
        """
        from dataflow_agent.agentroles.data_agents.websearch_initial_analyzer import create_websearch_initial_analyzer_agent
    ...
    async def web_researcher_node(state: WebsearchKnowledgeState) -> WebsearchKnowledgeState:
        ...
        - 抓取新网页内容，保存 DOM
        """
        from dataflow_agent.agentroles.data_agents.websearch_researcher import create_websearch_researcher_agent
    ...
    async def chief_curator_node(state: WebsearchKnowledgeState) -> WebsearchKnowledgeState:
        ...
        """
        from dataflow_agent.agentroles.data_agents.websearch_curator import create_websearch_curator_agent
