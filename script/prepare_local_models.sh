...
copy_file_if_missing "$LEGACY_SAM3_DIR/sam3.pt" "$LOCAL_SAM3_DIR/sam3.pt" || true
copy_file_if_missing "$LEGACY_SAM3_DIR/bpe_simple_vocab_16e6.txt.gz" "$LOCAL_SAM3_DIR/bpe_simple_vocab_16e6.txt.gz" || true
